...
\ies{IBTA - Instituto Brasileira de Tecnologia Avançada}
\iessigla{BILAC}
...
\orientadorcentro{IBTA-Bilac Instituto Brasileiro de Tecnologia Avançada}
...
\membrodabancadoisies{IBTA-Bilac Instituto Brasileiro de Tecnologia Avançada}

\membrodabancatres{Prof. Valentino D'ambrosi Junior}

\membrodabancatresies{IBTA-Bilac Instituto Brasileiro de Tecnologia Avançada}
...
\begin{document}	
   ...
   \imprimirlistadeabreviaturasesiglas	
	...
	\input{elementos-textuais/analise-e-levantamento-de-requisitos}	
