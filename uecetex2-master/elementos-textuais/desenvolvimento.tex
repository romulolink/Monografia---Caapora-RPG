...
\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=9cm]{figuras/CaiporaJogandoAgua}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
\subsection{Tree}
Esta classe representa as arvores no cenário e possui características herdadas da classe abstrata CreatureBase, possuindo assim pontos de vida e ataque podendo  morrer ao sofrer danos.
