...
\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=10cm]{figuras/animator}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
Na figura 26 temos um tile e o elemento de colisão em volta. As linhas que traçam um retângulo representam o colisor.
	...
	\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=10cm]{figuras/colisor}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
A figura 27 mostra o componente \textit{Rigidbody}.
	...
	\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=10cm]{figuras/rigi}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=10cm]{figuras/CaiporaComBalde}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=10cm]{figuras/CaiporaJogandoAgua}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=10cm]{figuras/FogoSeAlastrando}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=10cm]{figuras/NPC}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
	...
	\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=15cm]{figuras/DiagramaClassesPersonagens}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
A figura 33 apresenta a estrutura de Classes dos NPCs utilizada para o desenvolvimento do jogo.
	...
	\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=15cm]{figuras/DiagramaClassesNpc}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
\begin{figure}[h!]
		\centering
		\Caption{\label{fig:exemplo-1} Caipora próximo ao balde.}	
		\UECEfig{}{
			\fbox{\includegraphics[width=13cm]{figuras/CaiporaPegandoBalde}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
\begin{figure}[h!]
		\centering
		\Caption{\label{fig:exemplo-1} Caipora enchendo o balde.}	
		\UECEfig{}{
			\fbox{\includegraphics[width=13cm]{figuras/EnchendoBalde}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
...
\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=13cm]{figuras/MapaCompleto}}
		}{
			\Fonte{Elaborado pelo autor}
		}	
	\end{figure}
