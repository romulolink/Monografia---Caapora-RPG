...
\begin{figure}[h!]
		...
		\UECEfig{}{
			\fbox{\includegraphics[width=6cm]{figuras/193px-Pong}}
		}{
			\Fonte{\cite{pong}}			
		}	
	\end{figure}
...
Um dos dispositivos móveis em destaque é o \textit{smartphones}, no qual evidenciado na pesquisa realizada pela consultoria Nielsen, 68 milhões de brasileiros utilizam \textit{smartphones} \cite{nie} 
...
\begin{comment} Ainda de acordo com a empresa Flurry do grupo Yahoo, o uso de aplicativos cresceu em média 76\% em 2014. \cite{prox}
