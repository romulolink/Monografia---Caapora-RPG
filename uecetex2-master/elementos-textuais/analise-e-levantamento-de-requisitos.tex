...
\begin{table}[h!]	
	...
	\IBGEtab{}{
		\begin{tabular}{cp{13cm}}
			...
			RF7 & O jogo apresentará uma barra de vida do personagem Caapora que no qual ira diminuir toda vez que ele sofrer dano \\
			RF8 & O balde deverá ter uma barra de informação que informará a quantidade de aguá que já foi enchido\\
			...
			RF12 & Caso o jogador deixe o personagem amigo sofrer dados que o faça perder todos os pontos de vida será mostrada uma tela dizendo que o jogador falhou \\
			...
			RF15 & Os jogo deve exibir dicas por um período de tempo de como proceder em cada etapa na primeira fase  \\
...
\begin{table}[h!]	
	...
	\IBGEtab{}{
		\begin{tabular}{cp{13cm}}
			...
			RFN5 & O jogo deverá possuir portabilidade para múltiplas plataformas  \\
